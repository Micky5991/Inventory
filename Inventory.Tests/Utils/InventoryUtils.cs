...
namespace Micky5991.Inventory.Tests.Utils
{
    public static class InventoryUtils
    {
        ...
        public static ItemMeta CreateItemMeta(string itemHandle = "testhandle", Type itemType = null,
            string displayName = "FakeItem", int defaultWeight = 10, ItemFlags flags = ItemFlags.None)
        {
            if (itemType == null)
            {
            ...
            return new ItemMeta(itemHandle, itemType, displayName, defaultWeight, flags);
        }
